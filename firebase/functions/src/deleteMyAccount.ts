...
export const deleteMyAccount = onCall(async (request) => {
  ...
  for (const member of memberships.docs) {
    ...
    // Alerts created by a child are personal activity generated by that account.
    // Remove them as part of account deletion rather than leaving the structured
    // risk history behind in the family after the child account is removed.
    if (role === "child") {
